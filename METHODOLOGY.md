...
- M06 Installation_Difficulty_Penalty (Штраф за сложность или требования к специализированному оборудованию при установке РВД) - вес 0.05, штрафная метрика (вычитается)
- M07 Contamination_Risk_Probability (Вероятность внутреннего загрязнения или дефектов производства, влияющих на чистоту рабочей среды) - вес 0.02, штрафная метрика (вычитается)
